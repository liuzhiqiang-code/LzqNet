...
namespace LzqNet.DingtalkMessage.Consumer.Services;

public class DingtalkMessageService(IDingtalkPushMessageRecordRepository dingtalkPushMessageRecordRepository) : ISingletonDependency
{
    ...
    {
        var entities = await _dingtalkPushMessageRecordRepository.AsQueryable()
