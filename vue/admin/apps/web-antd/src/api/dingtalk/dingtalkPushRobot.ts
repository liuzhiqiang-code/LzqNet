...
async function getDingtalkPushRobotList() {
  return requestClient.post<Array<DingtalkPushRobotApi.DingtalkPushRobot>>(
...
async function createDingtalkPushRobot(
  ...
  return requestClient.post('/dingtalk/PushRobot/create', data);
}
...
async function updateDingtalkPushRobot(
  ...
  return requestClient.put(`/dingtalk/PushRobot/update`, data);
}
...
async function deleteDingtalkPushRobot(id: string) {
  return requestClient.delete(`/dingtalk/PushRobot/delete/${id}`);
}
